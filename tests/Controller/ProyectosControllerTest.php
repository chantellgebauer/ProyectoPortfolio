...
class ProyectosControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'proyecto[fecha]' => 'Testing',
            'proyecto[lenguajes]' => 'Testing',
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'proyecto[fecha]' => 'Something New',
            'proyecto[lenguajes]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getLenguajes());
